...
func (self *classicListener) receiveHello(impl *classicImpl) (*Message, *Hello, error) {
...
func (self *classicListener) ackHello(impl *classicImpl, request *Message, success bool, message string) error {
